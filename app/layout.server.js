  ...
  const categories = useMemo(() => [
    {
      ...
      sub: [
        ...
        "Eiendomsord", "Adjektiv", "Verb", "Subjunksjoner", "Спørреord",
        "Familien min", "Tid и Tall", "Mat", "Årstider и vær", "Активитеты",
        "Helse", "Reise", "Høytider", "Hjemмелив", "Клær", "Forhold",
        "Å skrivebrev", "Besøk", "Helгер и планы"
      ]
    },
    {
      title: "Setninger",
    ...
    {
      title: "Lesefорståelse",
      slug: "leseforstaelse",
      sub: []
    },
    {
      title: "Сkriftlig prøve",
                ...
                {cat.sub && cat.sub.length > 0 ? (
                  cat.sub.map((sub, i) => (
                    <li key={i}>
                      <Link
                        ...
                        className={`block px-2 py-1 rounded hover:bg-blue-100 transition ${
                          pathname.includes(sub.toLowerCase()) ? "bg-blue-200 text-blue-900" : "text-gray-600"
                        }`}
                      >
                        {sub}
                      </Link>
                  ...
                  <li>
                    <Link
                      href={`/${cat.slug}`}
                      className={`block px-2 py-1 rounded hover:bg-blue-100 transition ${
                        pathname.includes(cat.slug) ? "bg-blue-200 text-blue-900" : "text-gray-600"
                      }`}
                    >
                      Перейти
                    </Link>
